...
public class C3p0Pool implements Pool {
	...
	//	private C3p0Pool(String driver, String url, String user, String password) throws Exception
	//	{
	...
	//		properties.
	//	}
	private C3p0Pool(Properties properties)
	{
...
//		dataSource.setMaxIdleTime(60);   
	...
	public static Pool getInstance(int minPoolSize, int maxPoolSize, String driver,String url, String user, String password) throws Exception
	{
	...
	public static Pool getInstance(String driver, String url, String user, String password) throws Exception
	{
		Properties properties=getDefaultProperties();
		properties.setProperty("jdbcUrl", url);
		properties.setProperty("user", user);
	...
	public static Pool getInstance(Properties properties) throws Exception
	{
	...
	public String getKey() {
		if(_key==null)
		{
			...
			this._key=EncryptionUtil.getMD5(_key.getBytes());
		}
		return _key;
	}
